export const messages = {
    ...
    try_mint_more: (value) => `You're trying to mint more than the maximum payout available! The maximum mint payout is ${value} LWH.`,
    ...
    switch_to_matic: "Switch to the Matic network?",
