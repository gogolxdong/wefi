...
export const Web3ContextProvider: React.FC<{ children: ReactElement }> = ({ children }) => {
    ...
    const [uri, setUri] = useState(getMainnetURI(Number(DEFAULT_NETWORK)));
        ...
        new Web3Modal({
            ...
            providerOptions: {
                walletconnect: {
                    ...
                    options: {
                        rpc: {
                            [DEFAULT_NETWORK]: getMainnetURI(DEFAULT_NETWORK),
                        },
                    },
                },
            },
    ...
    const connect = useCallback(async () => {
        ...
        let network = await connectedProvider.getNetwork();
    ...
    const onChainProvider = useMemo(
        ...
        [connect, disconnect, hasCachedProvider, provider, connected, mobile, address, chainID, web3Modal, providerChainID],
    );
    //@ts-ignore
