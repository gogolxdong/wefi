...
export const getBalances = createAsyncThunk("account/getBalances", async ({ address, networkID, provider }: IGetBalances): Promise<IAccountBalances> => {
    ...
    return {
        balances: {
            slwh: ethers.utils.formatUnits(0, "gwei"),
            lwh: ethers.utils.formatUnits(0, "gwei"),
...
//         const testContract = new ethers.Contract(addresses.REFERRAL_ADDRESS, TestContract, provider);
